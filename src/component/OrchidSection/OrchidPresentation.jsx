...
function OrchidPresentation() {
    ...
    return (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 py-16">
            {orchids.map((orchid) => (
                <div className="w-full mb-4 bg-white dark:bg-black rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all transform duration-500" key={orchid.Id}>
                    <img className="w-full h-80 object-fit rounded-t-md" src={orchid.image} alt="" />
                    <div className="mt-2 p-4">
                        <h3 className="text-base font-bold text-gray-700 dark:text-white">{orchid.name}</h3>
